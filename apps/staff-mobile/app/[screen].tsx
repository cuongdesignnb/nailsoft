...
const titles: Record<string,string> = { invitation:"Invitation activation", branches:"My branches", sessions:"My sessions", profile:"My profile", language:"Language", workspace:"Workspace selection", mfa:"MFA challenge" };
