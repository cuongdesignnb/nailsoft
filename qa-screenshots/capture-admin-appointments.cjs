...
(async () => {
  ...
  for (const [name, viewport] of viewports) {
    ...
    await page.goto(`${adminBaseUrl}/admin/appointments`, { waitUntil: "networkidle" });
    ...
    await page.screenshot({ path: `artifacts/ui-completion/admin-appointments/${name}.png`, fullPage: true });
  }
  await browser.close();
  console.log(JSON.stringify({ route: "/admin/appointments", viewports: results }));
