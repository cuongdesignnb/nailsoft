...
const routes = [
  { path: "/admin/benefits/liability", heading: "Nghĩa vụ quyền lợi", dir: "admin-benefits-liability" },
  { path: "/admin/benefits/reports", heading: "Báo cáo quyền lợi", dir: "admin-benefits-reports" },
];
  ...
  for (const route of routes) {
    for (const [name, viewport] of viewports) {
      ...
      results.push({
        route: route.path,
        name,
        englishVisible: ["Benefit liability", "Benefit reports", "Voucher effectiveness", "Loyalty liability", "Membership counts", "Package liability", "Expiring benefits"].some((value) => bodyText.includes(value)),
