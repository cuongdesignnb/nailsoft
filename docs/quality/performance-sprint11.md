...
Indexes cover delivery claims, consent customer history, campaign audience generations, review scheduling, recovery branch/SLA and assignee tasks. Worker work is bounded and uses `SKIP LOCKED`; provider latency is outside database transactions.
