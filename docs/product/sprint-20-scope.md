...
WAVE4_SOURCE_CI=31657199445 / SUCCESS
...
## Wave 4 source and release closure
...
Repository-side hardening is complete and exact full CI is green. Sprint 20
cannot advance beyond `READY_FOR_STAGING` until the release operator supplies
the R1-R15 staging, infrastructure, provider and deployment evidence. Wave 3
remains deferred; the explicitly out-of-scope items remain unchanged.
