...
describe("OpenAPI contract", () => {
  it("declares the Sprint 1 API and common response envelopes", async () => {
    ...
    expect(contract).toContain("/communications/templates:");
    expect(contract).toContain("/marketing-campaigns:");
    expect(contract).toContain("/public/reviews/request:");
    expect(contract).toContain("/public/communications/unsubscribe:");
    expect(contract).toContain("/service-recovery/cases:");
  });
});
