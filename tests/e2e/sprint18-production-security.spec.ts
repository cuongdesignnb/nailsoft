...
test("denies unknown CORS origins without credential wildcarding", async ({ request }) => {
...
test("enforces branch scope and support-access gate on authenticated analytics", async ({ request }) => {
...
test("redacts invalid authentication errors and preserves request correlation", async ({ request }) => {
